...
This step is essential if you want to have the statistics of each item every day at the same time, this will be a real chart. 
...
2. Insert the following code in your wp-config.php file:
